...
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel0", { fg = "#696c76" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel1", { fg = "#c6e48b" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel2", { fg = "#7bc96f" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel3", { fg = "#239a3b" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel4", { fg = "#196127" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel5", { fg = "#0e4429" })
-- vim.api.nvim_set_hl(0, "GitDashboardContributionLevel6", { fg = "#003f00" })
